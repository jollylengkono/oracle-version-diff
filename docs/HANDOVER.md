...
5. UI defaults to Pixel Dark, with Supabase Light and GitHub Dark selectable.
...
- Pixel Dark is the default theme (`css/theme-pixel-dark.css`), with Supabase
  Light and GitHub Dark available from the theme switcher.
...
- Theme defaults to Pixel Dark, with Supabase Light and GitHub Dark available
